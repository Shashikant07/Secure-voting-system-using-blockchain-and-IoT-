...
<section class="container py-lg-5">>
  ...
  ?>
      <h1 class="slideInDown animated">Here is the users voting log</h1>
  ...
  ?>
      <h1 class="slideInDown animated">Scan Your Finger Here</h1>
      <div class="form-style-5">
        <button type="button" class="vote" id="<?php echo $_SESSION['finger_id']; ?>" >Proceed >></button>
      </div>
  <?php
      }
    }
